...
console.log("Final Ans::::", bubbleSort([3, 9, 1, 2, 5, 6]));
console.log("Final Ans::::", bubbleSort([9, 3, 2, 5, 4, 6, 0, 1, 7, 8]))


/** 
 *  Approach 1 : Take a flag, If in any iteration no swap is happened, it means array is already sorted. So, break the loop to optimize it.
 * Bubble Sort
