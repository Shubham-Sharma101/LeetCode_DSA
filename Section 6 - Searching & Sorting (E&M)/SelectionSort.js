...
console.log("Final Ans::::", selectionSort([7, 1, 5, 0, 4, 3, 2]));
console.log("Final Ans::::", selectionSort([7, 1, 5, -2, 12, 10, 4, 3, 2]));


/** 
 *  Approach 1 : If min index and i index is same, don't swap it.
 * Selection Sort
